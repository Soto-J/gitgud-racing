...
export default function SidebarToggle() {
  ...
  return (
    <header className="from-background via-background/95 to-background/90 border-border/50 relative flex items-center gap-x-4 border-b bg-linear-to-r px-4 py-3 shadow-sm shadow-black/5 backdrop-blur-md dark:shadow-white/5">
      <SidebarTrigger
        variant="outline"
