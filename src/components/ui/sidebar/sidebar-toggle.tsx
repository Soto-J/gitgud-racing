...
export default function SidebarToggle({ isLoggedIn }: SidebarToggleProps) {
  ...
  return (
    <header className="from-muted/50 via-background/70 to-muted border-border/50 relative flex items-center justify-between gap-x-4 border-b bg-linear-to-r px-4 py-3 shadow-sm shadow-black/5 backdrop-blur-md dark:shadow-white/5">
      <SidebarTrigger
        variant="outline"
